...
CAPABILITIES = {
    ...
    "openai": {
        ...
        "subagents": {"tier": "unsupported",
            "reason": "no deployable coordinator-over-roster: multi-agent is in-process SDK handoffs or static graph nodes under one workflow id",
            "remediation": "self-host via export, or wait for the standalone Workflows API"},
